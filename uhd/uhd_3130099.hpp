...
const std::vector<PyMethodDef> Uhd_gen_methods {
    ...
    {"get_rx_dc_offset_range", (PyCFunction)Uhd_get_rx_dc_offset_range, METH_VARARGS, ""},
    ...
    {"get_tx_dc_offset_range", (PyCFunction)Uhd_get_tx_dc_offset_range, METH_VARARGS, ""},
    ...
    {"is_device3", (PyCFunction)Uhd_is_device3, METH_VARARGS, ""},
