...
struct ReceiveRequest {
    ReceiveRequest(ReceiveRequestType type, size_t num_samps, std::vector<long unsigned int> &&channels,
...
class ReceiveWorker {
  ...
  public:
    ...
    ~ReceiveWorker();
    void init();
    std::future<void> request(ReceiveRequestType type, size_t num_samps = 0, std::vector<long unsigned int> &&channels = {},
